"""Tests for type conversion in DTO generation."""
...
def test_no_python_type_conversion() -> None:
    ...
    assert fields["no_python_field"].annotation == Any
...
def test_custom_sqlalchemy_type() -> None:
...
def test_mapped_annotations_vs_raw_column_types() -> None:
...
def test_generic_type_conversion() -> None:
    ...
    assert fields["list_of_strings"].annotation == list[str] | None
    assert fields["dict_of_int"].annotation == dict[str, int] | None


def test_postgresql_specific_types() -> None:
...
def test_mysql_specific_types() -> None:
...
def test_sqlite_specific_types() -> None:
